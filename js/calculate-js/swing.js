$(document).ready(function(){
    ...
    $('#step-9 .sel').click(function(){
        ...
        if(step9 == 1){
            $('#step-10-1').fadeIn();
            $('body').animate({scrollTop: $('#step-10-1').offset().top}, 1500);  
        } else if(step9 ==2){
            $('#step-10-2').fadeIn();
            $('body').animate({scrollTop: $('#step-10-2').offset().top}, 1500);
        }
    });
    // Prev
    ...
    $('#step-12 .sel').click(function(){
        if(step9 == 1){
            ...
            if(step2 == 1){
                $('#step-13-1').fadeIn();
                $('body').animate({scrollTop: $('#step-13-1').offset().top}, 1500);  
            } else if(step2 == 2){
                $('#step-13-2').fadeIn();
                $('body').animate({scrollTop: $('#step-13-2').offset().top}, 1500);
            }
        }
    });
    // Prev
