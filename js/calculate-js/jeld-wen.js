$(document).ready(function(){
    ...
    // 5
    $('#step-5 .size').click(function(){
        $('#step-5 .size').addClass('no-vubor');
        $(this).removeClass('no-vubor').addClass('vubor');
    ...
    $("#step-up-5").click(function(){
        $('#step-5 .size').removeClass('no-vubor').removeClass('vubor');
    ...
    $('#step-8 .sel').click(function(){
        ...
        if(step2 == 1){
            $('#step-9-1').fadeIn();
            $('body').animate({scrollTop: $('#step-9-1').offset().top}, 1500);  
        } else if(step2 ==2){
            $('#step-9-2').fadeIn();
            $('body').animate({scrollTop: $('#step-9-2').offset().top}, 1500); 
        }        
    });
    // Prev
